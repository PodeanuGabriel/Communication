...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { content: @reminder.content, from: @reminder.from, interval: @reminder.interval, subject: @reminder.subject, to: @reminder.to, type: @reminder.type }
    end
  ...
  test "should update reminder" do
    put :update, id: @reminder, reminder: { content: @reminder.content, from: @reminder.from, interval: @reminder.interval, subject: @reminder.subject, to: @reminder.to, type: @reminder.type }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
